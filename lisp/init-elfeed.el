...
(use-package elfeed
  ...
  (setq elfeed-feeds
        '(("https://taxodium.ink/rss.xml" :title "Taxodium")
          ...
          ("https://lucumr.pocoo.org/feed.atom" :title "Armin Ronacher" pi python)
          ("https://expensive.toys/rss.xml" :title "Artur Bień" emacs frontend css)
          ("https://atpx.com/feed.xml" :title "atpX")
          ("https://jeddacp.me/feed/" :title "Jedda" photo blaugust2026)
          ("https://notes.jeddacp.com/feed/" :title "Jedda" blaugust2026)
          ...
          ("https://kciter.so/feed.xml" :title "Sunhyoup Lee" Frontend)
          ("http://fyr.io/feed" :title "fyr.io" blaugust2026)
          ("https://francescrossley.com/feed/" :title "What the Fran" blaugust2026)
          ("https://wrywriter.ca/posts_feed" :title "Wry Writer" blaugust2026)
          ("https://zacharykai.net/assets/rss.xml" :title "Zachary Kai" blaugust2026)
          ("https://sals.place/index.xml" :title "Sal’s" blaugust2026)
          ("https://michaelharley.net/posts/feed.xml" :title "Michael Harley" blaugust2026)
          ("https://tallywinkle.bearblog.dev/feed/" :title "coffee spills" blaugust2026)
          ("https://luckyinstar.neocities.org/feed.xml" :title "Lucky Instar" blaugust2026 biologist)
          ("https://mogblog.pika.page/posts_feed" :title "MogBlog" blaugust2026)
          ("https://godless-internets.org/feed" :title "owlblog" :no-update blaugust2026 game)
          ("https://pinkway.mataroa.blog/rss/" :title "粉紅路" blaugust2026)
          ("https://granary.io/url?input=html&output=rss&url=https://asteriisms.com/blog" :title "Aster's Asterisms" blaugust2026)
          ("https://davehenry.blog/atom.xml" :title "Dave Henry Blog" blaugust2026)
          ("https://82mhz.net/index.xml" :title "82MHz" blaugust2026)
          ("https://www.bongotwisty.blog/index.xml" :title "BongoTwisty" blaugust2026)
          ("https://welshtroll.co.uk/feed/" :title "Point, Click, Repeat" blaugust2026)
