;;; init-gptel-magit.el --- gptel-magit -*- lexical-binding: t -*-
;;
;;; Commentary:
;;
...
;; messages.
;;
;; Fork from https://github.com/ragnard/gptel-magit
;;
;; Original Author: Ragnar Dahlén <r.dahlen@gmail.com>
;; SPDX-License-Identifier: Apache-2.0
;;
;; Changes:
;; - remove diff explain which i don't use
;; - make `gptel-magit-install' interactive,
;; and require `gptel' only when call `gptel-magit-install'
...
(provide 'init-gptel-magit)
;;; init-gptel-magit.el ends here
